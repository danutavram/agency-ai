        ...
        <Title title='Reach out to us' desc='From strategy to execution, we craft digital solutions that move your business forward.' />
         <form onSubmit={onSubmit} action="" className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
            ...
            <div className='sm:col-span-2'>
                ...
                <textarea name='message' rows={8} placeholder='Entery your message' className='w-full p-3 text-sm outline-none rounded-lg border border-gray-300 dark:border-gray-600' required/>
            </div>
