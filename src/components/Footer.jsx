    ...
    <div className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
        ...
        <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
            <div className='space-y-5 text-sm text-gray-700 dark:text-gray-400'>
                <img onClick={()=> window.scrollTo({top:0, behavior:'smooth'})} src={theme === 'dark' ? assets.logo_dark : assets.logo} className='w-32 sm:w-44 cursor-pointer' alt="" />
            ...
            <div className='text-gray-600 dark:text-gray-400'>
                ...
                <div className='flex gap-2 text-sm'>
                    ...
                    <button className='bg-primary text-white rounded px-6 cursor-pointer hover:scale-101 transition-all'>Subscribe</button>
                </div>
            </div>
        </div>
